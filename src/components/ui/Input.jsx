...
export default function Input({
  ...
  // Style Variants
  const baseInputStyles = "w-full px-4 py-2.5 rounded-3xl border-2  text-sm text-gray-900 bg-white placeholder:text-gray-400 transition-all duration-200 focus:outline-none focus:border-2 disabled:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed";
