...
const baseBtnStyles = "inline-flex items-center justify-between gap-3 h-12 rounded-2xl font-medium transition-all duration-200 cursor-pointer select-none active:scale-[0.99] disabled:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed text-base border";
...
export default function Button({
    ...
    const content = (
        <>
            ...
            {arrowIcon && (
                <span
                    className={`size-8 rounded-2xl flex items-center justify-center shrink-0 transition-transform duration-200 group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 ${isPillWithBadge
